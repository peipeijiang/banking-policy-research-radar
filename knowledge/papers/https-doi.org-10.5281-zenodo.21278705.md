---
title: "INTERPLAY BETWEEN ECONOMIC GROWTH, EXCHANGE RATE AND INSTITUTIONAL QUALITY ON PUBLIC DEBT IN NIGERIA (1986-2023)"
...
# INTERPLAY BETWEEN ECONOMIC GROWTH, EXCHANGE RATE AND INSTITUTIONAL QUALITY ON PUBLIC DEBT IN NIGERIA (1986-2023)

[查看原文](https://doi.org/10.5281/zenodo.21278705)

## 一句话结论

> 该论文研究尼日利亚1986-2023年间经济增长、汇率波动和制度质量对公共债务积累的影响，发现制度质量调节了经济增长和汇率对债务的作用。
...
本研究旨在考察1986-2023年间尼日利亚经济增长、汇率波动与制度质量对公共债务积累的三方交互作用。研究动机源于尼日利亚令人警惕的公共债务轨迹——尽管经历了数段有利的经济增长期，该国公共债务仍从2015年的12.6万亿奈拉飙升至2023年的超过97.3万亿奈拉。本研究采用年度时间序列研究设计，在误差修正框架内运用自回归分布滞后（ARDL）边界检验方法进行协整与中介效应分析。初步概念框架表明：经济增长对公共债务具有负向效应，而汇率贬值则呈现显著正向影响。关键假设在于制度质量对上述两种关系均起中介作用——薄弱制度会放大货币贬值的债务增加效应，同时削弱经济增长的债务削减潜力。研究发现，交互项（经济增长×制度质量、汇率×制度质量）具有统计显著性，表明制度质量从根本上调节了宏观经济基本面转化为债务结果的传导机制。政策建议强调需采取综合改革措施，将汇率稳定、增长多元化与制度强化（特别是腐败控制与政府效能提升）相结合，以实现非洲最大经济体的可持续公共债务管理。
