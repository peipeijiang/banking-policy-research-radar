---
title: "Technological Lock-in Due to Environmental Taxation"
...
[查看原文](https://ideas.repec.org/p/ces/ceswps/_12807.html)

## 一句话结论

> 论文研究承诺性排放税如何影响企业采纳随时间到来的清洁技术，发现承诺可能导致技术锁定，并分析了信息不对称和市场竞争的影响。
...
我们研究了一项承诺性的排放税如何影响在不确定性下随时间陆续出现的、逐步清洁的技术的采用。环境政策越来越依赖于预先设定并在新技术出现时保持固定的碳价格，而我们表明，这种承诺本身可能将企业锁定在劣质技术上。在一个两期模型中，技术仅在固定采用成本和排放率上有所不同；监管者承诺征收统一税，企业则选择是否以及何时采用。在具有完美预见性的垄断情形下，监管者可以诱导企业采用最清洁的技术，但当该技术的环境收益低于采用成本时，有时不这样做反而更好。在不完全信息下，承诺具有双向作用：低估最清洁技术出现的可能性会导致税率过低，从而使企业等待并停滞于初始技术；而高估该可能性则会导致税率过高，从而完全阻碍技术的采用。这种认知偏差仅扭曲了第一期的采用边际，其影响范围是一个收益-成本区间，该区间的宽度与误差大小成正比。竞争加剧了这一权衡。在对称企业的情况下，需要更高的税率才能触发技术采用，因此竞争明确提高了诱导绿色转型的成本——尽管垄断与双寡头的福利排序仍不明确。当一家企业享有采用成本优势时，这会缓解其竞争对手的采用难度，并减轻监管者的决策压力，这表明在税收之外，针对性的先期采用者支持也具有一定作用。
...
_知识库更新时间：2026-07-13T06:39:35.599189_
