...
paper_id: "repec:RePEc:oec:ecoaaa:1872-en"
source: "oecd"
...
[查看原文](https://ideas.repec.org/p/oec/ecoaaa/1872-en.html)

## 一句话结论

> 该论文发现加拿大的竞业限制条款广泛存在且日益增多，许多条款过于宽泛，阻碍了工人换工作或创业，并引发了对劳动力市场竞争的担忧。

## 论文信息

- **作者**：Dan Andrews, Andrea Garnero, Sara Holttinen
...
本文利用经合组织（OECD）对劳动者和企业的调查，为加拿大竞业限制及相关条款的普遍性及其潜在影响提供了新证据。研究发现，这些条款广泛存在且使用日益增多，且常被应用于最缺乏合理性的岗位。许多条款过于宽泛且法律效力薄弱，但仍有相当比例的劳动者报告称，其更换工作或创办企业的行为因此受到阻碍。声誉顾虑与道德考量等行为因素进一步强化了此类条款的影响。研究结果还凸显了（企业间）互不挖角与薪资固定协议的使用——这些协议限制了劳动力市场竞争，从而引发了加拿大竞争局（Canadian Competition Bureau）更广泛的关切。
...
_知识库更新时间：2026-07-13T04:30:56.246190_
