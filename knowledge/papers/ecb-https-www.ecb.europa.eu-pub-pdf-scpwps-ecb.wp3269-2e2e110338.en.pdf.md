---
title: "Forecasting the euro area job vacancy rate with earnings calls data"
paper_id: "ecb:https://www.ecb.europa.eu//pub/pdf/scpwps/ecb.wp3269~2e2e110338.en.pdf"
source: "ecb"
...
[查看原文](https://www.ecb.europa.eu//pub/pdf/scpwps/ecb.wp3269~2e2e110338.en.pdf)

## 一句话结论

> 利用企业财报电话会议文本构建劳动力需求指标，并纳入混合频率贝叶斯VAR模型，以改进欧元区职位空缺率的预测。
...
我们分析从企业财报电话会议中提取的文本信息是否能够改善对欧元区职位空缺率的预测。利用总部位于欧元区的企业的会议记录，我们基于与劳动力市场压力相关的关键词构建了一个月度劳动力需求指标，并将其与标准的硬指标和软指标一同纳入混合频率贝叶斯向量自回归模型。伪实时评估显示，财报电话会议为追踪职位空缺动态提供了及时且有价值的信号。在各类软指标中，限制生产的因素带来了最大的预测增益，而一旦纳入定性信号，失业率等真实劳动力市场指标的增量贡献则十分有限。预测改进主要来自制造业部门的信息，其信号在信息含量上显著优于服务业，尤其是与财报电话会议结合使用时更为明显。总体而言，我们的研究结果凸显了高频文本信息在改善欧元区短期劳动力需求预测方面的实用价值。
...
_知识库更新时间：2026-08-06T03:57:42.791743_
