...
> **英文原标题**：Monetary Policy Transmission in the Euro Area

[查看原文](https://doi.org/10.1017/cbo9780511492372)

## 一句话结论

> 该论文通过宏观VAR、结构模型以及银行和企业面板数据，系统研究了欧元区货币政策传导机制，发现银行信贷渠道在传导中发挥重要作用。
...
正确实施货币政策需要理解货币传导机制，以便监测经济状况、制定政策立场并向公众解释政策行动。因此，收集欧元区货币传导机制的证据一直是欧元体系（Eurosystem）的优先事项。这本2003年出版的著作展示了由欧洲中央银行（European Central Bank）及其他欧元体系央行共同开展的多年合作项目成果。首先，通过向量自回归模型（VARs）和结构模型对欧元区整体及各成员国的宏观数据进行了系统研究。其次，本书利用银行与企业面板数据，呈现了关于货币政策影响的前所未有的系列研究。各国央行经济学家撰写的国别案例研究与综述文章，以及知名学者撰写的讨论章节，为该领域的研究做出了重要贡献。
...
这是一部2003年出版的学术专著，汇集欧洲中央银行及欧元体系各国央行的多年合作研究，系统讨论欧元区货币政策传导机制。全书同时使用宏观VAR、结构模型，以及银行和企业面板数据，覆盖欧元区整体、成员国差异和银行信贷渠道。当前未获得与该书身份一致的公开全文，因此这里只依据出版社摘要概括，不能把其他同名论文的实验结果归入本书。

### 研究方法

出版社摘要表明，本书一方面使用VAR和结构模型分析欧元区整体及各成员国的宏观传导，另一方面汇集基于银行与企业面板数据的国别研究；摘要未提供各章节的具体模型设定。

### 关键结果

摘要确认本书形成了欧元区货币传导、银行信贷渠道和国别差异的系统证据，但未披露可核验的统一估计值、显著性水平或跨章节结论，需获取身份一致的正文后才能进一步评价。

### 主要局限

- **论文本身局限**：出版社摘要未说明论文本身的局限。
- **当前证据局限**：未获取与2003年专著身份一致的正文，当前分析仅基于出版社摘要。

### 与当前研究方向的关联

与货币政策传导、银行信贷渠道和欧元区金融结构直接相关。
...
_知识库更新时间：2026-07-13T15:13:29.885534_
