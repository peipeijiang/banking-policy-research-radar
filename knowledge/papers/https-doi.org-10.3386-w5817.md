...
[查看原文](http://doi.org/10.3386/w5817)

## 一句话结论

> 论文探讨了私人资产和政府债券在满足企业流动性需求中的作用，指出在总体不确定性下政府债券能提供流动性溢价，并可通过调整政府债券供给来管理流动性。
...
本文探讨了一个基本但尚未解决的问题：对私人资产的要求权能否为生产部门的有效运行提供充足的流动性？还是说，国家在创造流动性并通过调整政府证券存量或其他手段对其进行监管方面应发挥作用？在我们的模型中，企业可以通过三种方式满足未来的流动性需求：发行新的要求权并稀释旧的要求权、从金融中介机构获得信贷额度，以及持有对其他企业的要求权。当不存在总体不确定性时，我们证明这些工具足以实现投资者与企业之间的社会最优（次优）契约。这种契约对企业施加了最大杠杆比率和流动性约束。金融中介机构协调流动性的使用。如果没有中介，稀缺的流动性可能会被浪费，社会最优状态可能无法实现。当仅存在总体不确定性时，私人部门在流动性方面不再能够自给自足。政府可以通过发行承诺未来消费者收入的债券来改善流动性。政府债券相对于私人要求权享有流动性溢价。流动性的供给可以通过在总体流动性冲击较高时放松流动性（提升其证券价值），在冲击较低时收紧流动性来进行管理。因此，本文为政府提供流动性以及积极政府政策的可能性提供了一个微观经济学的例证。
...
_知识库更新时间：2026-07-14T03:57:10.409042_
