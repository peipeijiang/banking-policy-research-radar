...
[查看原文](http://arxiv.org/abs/2608.01432v1)

## 一句话结论

> 提出繁荣价值理论（FVT），作为后AGI经济学的基础，重新定义价值为对个人和社区繁荣能力的反事实贡献，并区分价值创造与价值捕获。
...
通用人工智能（AGI）可能会削弱支撑既有经济价值理论的劳动、专业知识、信息及生产能力方面的稀缺性。若认知工作被广泛自动化，市场价格、劳动投入、显示性偏好、利润及总产出可能与人类及社会福祉严重脱节。本文提出“繁荣价值理论”（Flourishing Value Theory, FVT），作为后AGI时代经济学的基础。FVT将价值定义为系统、制度、资产或干预措施对社会与地球约束下个人及社群持久繁荣能力的反事实性、分配敏感性贡献。该理论将社会价值视为多维度的、维护主体性的、再生的，并在关键阈值上具有不可补偿性。本文借鉴人工智能经济学、福利与能力理论、自动化、数字估值及生态经济学，区分了价值创造与价值捕获，并将价格、利润、生产率和GDP视为部分信号而非进步的最终衡量标准。本文进一步阐述了从稀缺到受治理的丰裕、从交易到转型、从零和对抗到正和及无限博弈动态的转变，并将集体意识扩展视为一种维护主体性的再生价值形式。在繁荣度量（Flourishing Metrics）与繁荣回报率（Return on Flourishing, RoF）的基础上，本文提出了面向企业、政府、工作转型、AI治理及国民核算的分层架构。后AGI时代的核心经济问题并非如何最大化产出，而是如何将充裕的智能转化为持久的、公平分配的人类、社会与地球繁荣。
...
_知识库更新时间：2026-08-04T04:07:03.485806_
