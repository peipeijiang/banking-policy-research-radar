...
[查看原文](https://ideas.repec.org/p/fip/fedpwp/103512.html)

## 一句话结论

> 论文研究抵押贷款利率上升导致的房主锁定效应是否解释了房地产市场的低交易量、短上市时间和持续价格上涨，发现锁定效应减少了交易，但买家对利率更敏感，利率下降会增加交易量但不会缓解市场紧张。
...
高企的抵押贷款利率抑制了房主搬迁意愿，因为换房会触发抵押贷款条款重置——这一现象被称为“锁定效应”。本文旨在探究高利率是否解释了近期房地产市场的紧缩现象：交易量低迷、挂牌时间缩短以及价格持续上涨。基于交易层面数据，我们构建了住房持有期的生存模型——将出售概率视为持有期与市场条件（包括抵押贷款利率差）的函数。这些估计量化了因高利率而未能进入市场的缺失卖方数量。随后，我们校准了一个搜索匹配模型，用以衡量抵押贷款利率对买方的影响以及卖方锁定效应。结果表明，锁定效应导致卖方退出市场，从而减少交易量。然而，买方对抵押贷款利率的敏感度高于卖方对锁定效应的敏感度，这意味着利率下降将增加交易量，但不会缓解市场紧缩程度。
...
_知识库更新时间：2026-07-13T04:30:56.247244_
