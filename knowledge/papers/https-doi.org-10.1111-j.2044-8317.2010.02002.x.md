...
paper_id: "https://doi.org/10.1111/j.2044-8317.2010.02002.x"
source: "citation"
published: "2011-01-13T00:00:00"
score: 0.0
tags: ["paper", "banking-fiscal-monetary-policy", "Advanced Statistical Methods and Models"]
---

# Clarifying the role of mean centring in multicollinearity of interaction effects

[查看原文](https://doi.org/10.1111/j.2044-8317.2010.02002.x)

## 一句话结论

> 该论文澄清了均值中心化在交互效应多重共线性中的作用，表明均值中心化可能增加或减少多重共线性，但不影响交互效应的检验统计量。
...
- **发布时间**：2011-01-13
- **相关度评分**：0.0
- **DOI**：[https://doi.org/10.1111/j.2044-8317.2010.02002.x](https://doi.org/10.1111/j.2044-8317.2010.02002.x)
...
> 最高匹配领域：商业银行 0.0/10。论文研究的是多元回归中均值中心化对多重共线性的影响，属于统计方法学领域，与商业银行、货币政策、财政政策均无实质关联。

<details open>
<summary><strong>中文摘要</strong></summary>

调节性多元回归（MMR）常用于分析连续预测变量之间的交互效应。通常建议采用均值中心化方法，以缓解预测变量与其构造的交叉乘积项之间可能存在的多重共线性威胁。此外，中心化通常能更直观地解释低阶项。本文试图澄清两个可能引起混淆的方法论问题。首先，探讨了均值中心化对多重共线性诊断的正向与负向影响。研究表明，根据数据特征的不同，均值中心化方法可能增强或减弱多重共线性的各项测量指标。其次，本文给出了均值中心化不影响交互效应检测的确切原因。解释表明，均值中心化对乘积变量的校正平方和与方差膨胀因子具有对称性影响，同时保持了乘积项对两个预测变量回归的两个残差平方和之间的等价性。因此，尽管均值中心化明显改变了多重共线性，但最终的检验统计量保持不变。这些发现为理解并展示均值中心化在MMR应用中的多样化影响提供了清晰的依据。
...
_知识库更新时间：2026-07-13T04:30:56.247783_
