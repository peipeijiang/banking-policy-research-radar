...
paper_id: "repec:RePEc:ces:ceswps:_12809"
source: "cesifo"
...
[查看原文](https://ideas.repec.org/p/ces/ceswps/_12809.html)

## 一句话结论

> 该论文通过实验发现女性自我推销较少，导致她们获得更具挑战性任务建议的可能性降低12个百分点，且这种性别差距在多种条件下持续存在。

## 论文信息

- **作者**：Rigissa Megalokonomou, Juliana Silva-Goncalves, Roel van Veldhuizen
...
> 最高匹配领域：商业银行 0.0/10。论文研究性别差异在自我推销和职业建议中的作用，通过实验设计分析建议者如何根据自我评估给予职业建议。研究问题、方法和结果均不涉及商业银行、货币政策或财政政策的核心主题。没有银行、信贷、利率、通胀、政府支出、税收等关键词。因此三个领域均为0分。

<details open>
<summary><strong>中文摘要</strong></summary>

我们研究了自我推荐与职业建议在维持劳动力市场结果中的性别差异方面所起的作用。我们开展了一项预先注册的实验，实验中“建议者”为“工作者”提供建议，使其尝试更具挑战性或较不具挑战性的任务。我们发现，女性的自我推荐程度低于男性，因此，她们被建议选择更具挑战性任务的可能性低12个百分点。这种建议中的性别差异在定量与定性自我评估中均持续存在，并且对建议者信息集的变化具有稳健性——包括当建议者观察到工作者的实际表现时——但当建议者被告知自我推荐中存在性别差异时，这种差异消失甚至发生逆转。
...
_知识库更新时间：2026-07-13T04:30:56.246745_
