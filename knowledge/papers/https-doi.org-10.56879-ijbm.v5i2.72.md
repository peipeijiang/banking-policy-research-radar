---
title: "Measurement failure and farm gate income loss in Tanzania: A practitioner based study of legal metrology enforcement"
paper_id: "https://doi.org/10.56879/ijbm.v5i2.72"
source: "openalex"
published: "2026-07-13T00:00:00"
score: 0.0
tags: ["paper", "banking-fiscal-monetary-policy", "Global trade, sustainability, and social impact", "Agricultural Innovations and Practices", "Land Rights and Reforms"]
---

# Measurement failure and farm gate income loss in Tanzania: A practitioner based study of legal metrology enforcement

[查看原文](https://doi.org/10.56879/ijbm.v5i2.72)

## 一句话结论

> 该论文通过混合方法研究坦桑尼亚市场测量不准确对消费者福利的影响，发现小农户因称重、皮重扣除和水分评估误差导致农场收入损失3-8%。

## 论文信息

- **作者**：Almachius Pastory
- **来源**：International Journal of Business and Management (IJBM)
- **发布时间**：2026-07-13
- **相关度评分**：0.0
...
在非正规与半正规市场中，测量不准确对撒哈拉以南非洲地区的消费者福利构成了持续但鲜有记录的威胁。尽管该地区许多国家已建立法定计量学框架，但执法能力仍参差不齐，且测量失误对弱势市场参与者的经济影响很少得到系统评估。本文研究了测量不准确如何影响坦桑尼亚零售及农产品市场中的消费者福利，并评估了坦桑尼亚度量衡局（Weights and Measures Agency, WMA）旨在缓解测量相关贸易纠纷的监管机制。采用收敛混合方法设计，本研究将来自城市零售市场、燃油加注点及湖区（卡盖拉地区）农产品采购中心长达十五年的从业者现场检查数据，与对交易者及购买者行为的结构化观察、WMA执法记录、国际法制计量组织（OIML）技术标准以及东非共同体（East African Community, EAC）监管文件的文献分析相结合。证据识别出测量失误损害市场参与者的四条主要路径：零售环境中的秤漂移与蓄意篡改、农村商品贸易中的非标准体积计量、通过电子操控与泡沫充注导致的燃油加注点短量，以及移动支付与预包装商品系统中的数字交易差异。在湖区采购中心出售棉花和玉米的小农户成为受影响最严重的群体之一，称重、皮重扣除及水分评估中的复合误差估计使每笔交易周期的有效农场门口收入减少3%至8%。研究结果表明，通过测量治理实现有效的消费者保护需要加强现场检查能力、协调EAC与南共体（SADC）层面的计量标准，并将法定计量学正式纳入农业价值链监管，这为撒哈拉以南非洲各国的国家计量机构提供了实践启示。
...
_知识库更新时间：2026-07-14T03:57:10.394155_
