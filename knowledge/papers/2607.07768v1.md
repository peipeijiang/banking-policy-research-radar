...
> 最高匹配领域：财政政策 2.0/10。commercial_banking: 论文研究社区层面的社会经济影响，不涉及银行或信贷中介，得0分。monetary_policy: 未讨论货币政策工具、传导或政策含义，得0分。fiscal_policy: 论文提及政府干预和公共支出，但主要关注社区恢复而非财政政策核心议题（如预算、税收、债务），仅作为背景，得2分。最高匹配领域为fiscal_policy，但分数低。
