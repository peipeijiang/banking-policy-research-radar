...
[查看原文](https://doi.org/10.3386/w6652)

## 一句话结论

> 本文利用结构模型识别并量化了基本面和金融因素对企业投资的影响，发现金融摩擦使投资对扩张性冲击的总体响应提高25%，且小企业和无债券评级企业受金融因素影响更大。
...
诸如现金流和现金存量等金融变量，在企业层面的投资中，是稳健且具有定量重要性的解释变量。近期大量实证研究将这些发现归因于资本市场的不完善。然而，这种解释存在争议，因为即使在没有资本市场不完善的情况下，如果这些金融变量包含关于资本预期边际价值的信息，它们仍可能作为投资的解释变量出现。在本文中，我们展示了如何利用带有昂贵外部融资成本的结构性投资模型来识别并量化投资的“基本面”与“金融面”决定因素。我们的实证结果表明，投资对基本面因素和金融因素均有显著反应。来自我们结构性模型的点估计显示，对于样本中的平均企业而言，与金融摩擦为零的基准情形相比，金融因素使投资对扩张性冲击的整体反应提高了25%。与理论一致的是，小型企业和无债券评级的企业对金融因素的反应最为强烈，而一旦我们控制了投资基本面因素，有债券评级的企业几乎未显示出任何反应。
...
_知识库更新时间：2026-07-14T03:57:10.406900_
