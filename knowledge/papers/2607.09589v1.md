...
> 最高匹配领域：财政政策 2.0/10。commercial_banking: 论文完全不涉及商业银行、信贷或金融中介，评0分。monetary_policy: 论文不涉及货币政策工具、传导或政策含义，评0分。fiscal_policy: 论文提及煤炭地区的财政依赖（fiscal dependence），但主要研究失业和GDP增长，未深入分析税收、支出或债务等财政政策工具，仅作为背景间接提及，评2分。最高匹配领域为fiscal_policy，但得分很低。
