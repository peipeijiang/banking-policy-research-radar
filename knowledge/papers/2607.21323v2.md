...
[查看原文](http://arxiv.org/abs/2607.21323v2)

## 一句话结论

> 本文开发了一种半非参数需求估计的筛子最小距离估计量，利用微观数据中的消费者协变量变化来恢复异质性函数和复合截距，并证明估计量的一致性和渐近性质。
...
本文针对具有微观层面选择数据的半非参数差异化产品需求模型，提出了一种剖面筛最小距离估计量。该估计量基于Berry与Haile（2024）的研究，利用消费者协变量在市场内部的变动来恢复灵活的消费者异质性函数及市场特定复合截距项。通过排除价格工具变量，将这些截距项分解为灵活的价格侧函数与结构性需求冲击。主要统计挑战在于剖面市场截距项的数量会随市场数量增加而增长。研究表明，当市场数量与市场内最小样本量同时增长时，该剖面步骤在渐近意义上可忽略不计，且常见结构性函数可获得一致估计。蒙特卡洛模拟结果支持该一致性结论，并揭示了灵活的价格侧估计对反事实需求分析的重要价值。
...
_知识库更新时间：2026-07-29T03:57:13.174490_
