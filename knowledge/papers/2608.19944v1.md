...
[查看原文](http://arxiv.org/abs/2608.19944v1)

## 一句话结论

> 提出一个隐私预算框架，通过差分隐私控制第三方对消费者分组的推断，并优化在线实验的探索与利用平衡。
...
企业利用多臂老虎机进行在线实验，以个性化地向消费者展示内容，同时平衡探索与利用之间的关系。然而，第三方可以通过观察消费者收到的横幅、广告或推荐来推断其潜在细分群体。为控制这种推断，我们提出了一种隐私风险预算，企业可事先设定该预算，利用差分隐私来限制第三方的信念更新。为消耗这一隐私风险预算，我们提出了两种策略：恒定隐私风险策略和动态隐私风险策略，二者在不同访客之间以不同方式消耗隐私风险。我们研究了在这两种策略下，隐私风险预算如何影响两类应用——网站设计与推荐系统——中的实验表现。针对这两种策略，我们通过解析方法找到了能够最优平衡探索与利用的隐私风险预算。随后，我们将实验层面的隐私风险预算扩展至企业层面的隐私风险预算，并在包含78个实验的实证环境中应用该企业级隐私风险预算。我们发现，动态策略在时间更长、复杂度更高的实验中尤为有价值，并且优化企业级隐私风险预算在各实验间的分配能够显著提升学习表现。
...
_知识库更新时间：2026-08-21T02:19:53.851016_
