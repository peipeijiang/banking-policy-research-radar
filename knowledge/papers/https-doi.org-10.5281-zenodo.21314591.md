---
title: "Deterministic Cosmic Architecture: Linking Global Dark Matter and Local Star Formation through Carrollian Freezing"
paper_id: "https://doi.org/10.5281/zenodo.21314591"
source: "openalex"
published: "2026-07-11T00:00:00"
score: 0.0
tags: ["paper", "banking-fiscal-monetary-policy", "Galaxies: Formation, Evolution, Phenomena", "Cosmology and Gravitation Theories", "Gamma-ray bursts and supernovae"]
---

# Deterministic Cosmic Architecture: Linking Global Dark Matter and Local Star Formation through Carrollian Freezing

[查看原文](https://doi.org/10.5281/zenodo.21314591)

## 一句话结论

> 该论文提出一个基于广义相对论和BKL猜想的宇宙学框架，通过卡洛里冻结机制解释暗物质、星系形成和宇宙循环，与经济学无关。
...
我们提出了一种多尺度几何框架，该框架在不借助奇异扩展、隐藏维度或未发现亚原子场的情况下，修补了广义相对论在奇点极限处的经典崩溃阈值。在别林斯基-哈拉特尼科夫-利夫希茨（BKL）猜想的原理指导下，我们表明，在暴胀末期，坍缩原初质量内部的极端体积收缩会引发瞬时的卡罗尔相变（此时局部光速趋近于零）。这种度规退化强制施加了严格的坐标速度钳制，正则化了曲率不变量，同时保留了一个稳定、无辐射、宏观隔离的引力质量印记。这些残余物以稀疏的平均间隔约24天文单位分布，形成一个全局、无碰撞的背景矩阵，自然解释了100%的宇宙冷暗物质预算，并安全避开了光学微引力透镜巡天的限制。至关重要的是，我们的框架推导出光速的宇宙值并非任意常数，而是一个刚性边界条件，被精细调节以在托尔曼-奥本海默-沃尔科夫（TOV）核失效极限处充当几何断路器。在星系尺度上，局部残余物以紧密的215米间隔分布形成过密度，解决了核心-尖点问题，并构成一个扩展的、零反馈的引力海绵。由此产生的二次吸积级联抑制了局部辐射压力梯度，为在高红移詹姆斯·韦伯空间望远镜（JWST）小红点（LRD）星系中观测到的反常“X射线弱”和加速质量聚集提供了直接的几何解释。缩小到恒星系统，该框架表明单个残余物将局部金斯质量降至零，导致主序星与核吸积气态巨行星之间的双星质量发散，这与追踪低频引力模式的活跃日震学数据相符。在全球宇宙尺度上，我们扩展了这一框架，表明一次总宇宙坍缩会在普朗克边界处引发绝对的几何压力梯度发散，为循环大反弹提供了微观物理机制。最后，我们提出了通过激光干涉仪空间天线（LISA）轨道失相和罗曼空间望远镜弱引力透镜微斑图进行实验可证伪性的明确方案。
...
_知识库更新时间：2026-07-13T03:20:00.920709_
