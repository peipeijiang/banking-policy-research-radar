---
title: "Ownership structure, financial leverage, and company performance; A study of companies on Nigeria Stock Exchange"
...
# Ownership structure, financial leverage, and company performance; A study of companies on Nigeria Stock Exchange

[查看原文](https://doi.org/10.51594/rjbs.v1i2.17)

## 一句话结论

> 该论文研究了尼日利亚制造公司的所有权结构和财务杠杆对公司绩效（ROA）的影响，发现管理层所有权正向影响绩效，而高财务杠杆负向影响绩效。
...
本研究分析了尼日利亚公司所有权结构、财务杠杆对公司绩效的影响。具体而言，研究以资产收益率（ROA）作为绩效的代理指标，考察了管理层所有权、机构所有权、外资所有权及财务杠杆对尼日利亚部分上市制造公司绩效的影响。代理理论作为支撑本研究的主要理论，而权衡理论与优序融资理论则对公司融资决策及资本结构提供了补充性解释。本研究采用事后回溯研究设计，使用了2019-2025年间五家选定上市制造公司已公布年报中的历史二手数据，共涉及35个公司-年度的面板数据。分析通过描述性统计、相关性分析、方差膨胀因子检验、异方差性检验、增广迪基-富勒（ADF）单位根检验及混合普通最小二乘法（OLS）回归分析完成。管理层所有权对公司绩效具有正向且统计显著的影响，研究结论认为管理层所有权的增加会正向提升公司绩效，因其能更好地协调管理层与所有者之间的利益关系。财务杠杆与绩效之间的负向关系表明，过度增加债务融资会对公司绩效产生负向且统计显著的影响，因为这会提高融资成本与财务风险，进而对盈利能力产生负面影响。然而，机构所有权与外资所有权对ROA的影响虽为正向但不显著。整体回归模型具有统计显著性，可解释公司绩效约63.15%的变异。经研究得出结论：管理层所有权能改善财务绩效，但高财务杠杆会降低盈利能力。因此，本研究建议制造公司应鼓励管理层持股、采用最优负债比率、强化机构投资者的监督职能，并促进优质外资参与公司治理。关键词：所有权，结构，回报，外资，公司，尼日利亚。
