...
> 该论文提出增强的多目标进化算法来解决带有基数约束的大规模投资组合优化问题，通过新的解表示、算子和修复机制实现更快的收敛和更好的近似解。
...
> 最高匹配领域：商业银行 0.0/10。论文研究的是投资组合优化问题，使用多目标进化算法处理基数约束。问题属于金融工程和运筹学领域，不涉及商业银行、货币政策或财政政策。没有银行、信贷、中央银行、政府支出等核心概念。因此三个领域均为0分。

<details open>
<summary><strong>中文摘要</strong></summary>

决策正对投资者构成日益严峻的挑战，原因在于金融市场中可供选择的投资标的数量持续增长。过去几十年的研究热点之一便是投资组合优化，其旨在确定投资者应在各类资产上投入多少资金。将现实条件引入优化模型后，该问题转化为NP难问题，精确求解方法对此类问题效率低下；因此，研究者转而采用进化算法来获取近似解。本文针对基数约束下的投资组合优化问题，提出了多目标进化算法的强化策略，该策略能够实现更快的收敛速度与广泛的搜索能力。为实现这些特性，我们引入了独特的解表示方法、新型算子及新的修复机制，以解决上述问题中投资组合资产数量存在上下限约束的情形。为此，我们将新型交配策略与前述方案相结合，在经典多目标进化算法中实施以求解该问题。随后，以知名市场指数为基准，将定制化算法与传统算法进行对比测试。结果表明，所提策略不仅能提供更优的近似解，而且收敛速度更快，且随着市场中资产数量的增加，其性能不会出现损失。
...
_知识库更新时间：2026-07-13T03:20:00.918761_
